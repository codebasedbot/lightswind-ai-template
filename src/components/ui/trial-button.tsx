...
export const TrialButton: React.FC<TrialButtonProps> = ({
  ...
  return (
    <>
      ...
      <button
        className="backdrop-blur-md !font-bold shiny-custom-styles 
        border-border isolate relative overflow-hidden cursor-pointer 
        outline-offset-4 py-[0.75rem] px-[1.25rem] text-base leading-tight 
        !rounded-full text-black dark:text-white bg-white dark:bg-black active:translate-y-px flex items-center justify-center"
        style={
          {
